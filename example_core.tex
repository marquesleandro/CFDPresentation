...
\begin{tikzpicture}[scale=1.8]
 ...
 \node at (0.5,1.5) {\scriptsize Mini Element};
 ...
 \node[circle, fill=black, inner sep=0pt, minimum size=5pt,label=above:{4}] at (0.5,2.3) {};
...
\hspace{-1cm}
\begin{column}{0.3\textwidth}
$\text{numNodes}=0$\\[0.1cm]
$\text{numVerts}=1$\\[0.1cm]
$\text{numElements}=54.5$\\[0.1cm]
$\text{dt}=0$ \qquad $\text{nt}=0$
\end{column}
\end{columns}
\end{center}
\justifying
